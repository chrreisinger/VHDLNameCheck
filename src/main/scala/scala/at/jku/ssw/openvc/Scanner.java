package scala.at.jku.ssw.openvc;
...
public class Scanner {
	...
	static {
		...
		for (int i = 65; i <= 66; ++i) start.set(i, 1);
		for (int i = 68; i <= 90; ++i) start.set(i, 1);
		...
		literals.put("Development", new Integer(6));
		literals.put("Tools", new Integer(7));
	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 4:
					if (ch >= ' ' && ch <= '~') {AddCh(); state = 3; break;}
					else {t.kind = noSym; break loop;}
				case 5:
					{t.kind = 3; break loop;}
				case 6:
					if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '&' || ch >= '(' && ch <= '[' || ch >= ']' && ch <= 65535) {AddCh(); state = 7; break;}
				...
				case 9:
					...
					else if (ch == 39) {AddCh(); state = 10; break;}
					else {t.kind = noSym; break loop;}
				case 10:
					{t.kind = 4; break loop;}
				case 11:
				...
				case 13:
					...
					else if (ch == 'o') {AddCh(); state = 14; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 14:
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'b' || ch >= 'd' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'c') {AddCh(); state = 15; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 15:
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); state = 1; break;}
					else if (ch == 'o') {AddCh(); state = 16; break;}
					else {t.kind = 1; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
				case 16:
					if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); state = 1; break;}
